module.exports = function companyRegistrationEmail({ companyName, otp }) {
    return {
        subject: 'Your OTP for SkillHunt Company Registration',
        html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;">
        <h2 style="color: #27428E;">SkillHunt Registration OTP</h2>
        <p>Hello <strong>${companyName}</strong>,</p>
        <p>Thank you for initiating your company registration on <strong>SkillHunt</strong>.</p>
